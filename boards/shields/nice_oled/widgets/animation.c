...
#if IS_ENABLED(CONFIG_NICE_OLED_WIDGET_STATIC_IMAGE_PERIPHERAL_MUDGET)
LV_IMG_DECLARE(mudget);
#define FIXED_IMAGE_MUDGET &mudget
...
#if IS_ENABLED(CONFIG_NICE_OLED_WIDGET_STATIC_IMAGE_PERIPHERAL_MUDGET)
    lv_img_set_src(art, FIXED_IMAGE_MUDGET);
#elif IS_ENABLED(CONFIG_NICE_OLED_WIDGET_STATIC_IMAGE_PERIPHERAL_VIM)
